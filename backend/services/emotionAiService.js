...
function analyzeText(textNarrative = "") {
...
function analyzeEmotions(textNarrative = "") {
  return analyzeText(textNarrative);
}
...
module.exports.EmotionAiService = EmotionAiService;
module.exports.analyzeText = analyzeText;
module.exports.analyzeEmotions = analyzeEmotions;
